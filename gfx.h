...
#define TEXT_SMALL_X(x)         (TEXT_X_0 + FONT_SMALL_SIZE_X_PX * (x))
#define TEXT_SMALL_Y(y)         (TEXT_Y_0 + (FONT_SMALL_SIZE_Y_PX) * (y))
#define TEXT_SMALL_Y_CENTER(y)  (screen->h / 2 + (FONT_SMALL_SIZE_Y_PX) * (y))
